  ...
  return (
    <div className="w-full bg-[#1e1e1e] min-h-screen flex justify-center items-center">
      <div className="w-full md:w-[95%] xl:w-[55%] flex justify-center items-center relative">
        ...
        <div className="w-[95%] md:w-[80%] xl:w-[65%] bg-black rounded-[1rem] h-fit flex flex-col items-center justify-start mt-0 gap-6 p-2 py-5 pb-10 xl:pb-[1.8rem]  md:p-10 xl:p-6 ">
